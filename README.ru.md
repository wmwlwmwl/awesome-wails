...
- [Redis Viewer](https://redisviewer.com) - Бесплатный кроссплатформенный десктопный клиент Redis для больших keyspace, декодирования Java-сериализованных значений и локального анализа узких мест (SlowLog, BigKey, HotKey).
