...
- [MQ Studio](https://github.com/amigoer/mq-studio) - Локальный десктопный клиент для очередей сообщений. Единая модель подключаемых драйверов для RocketMQ, RabbitMQ и Kafka: топики, группы потребителей, сообщения и состояние кластера на одних и тех же экранах. Развёртывание веб-консоли не требуется.
- [LumeTerm](https://github.com/wmwlwmwl/LumeTerm) - Лёгкий, быстрый и кроссплатформенный SSH-клиент на основе Go-конкурентности + локальный WebSocket + xterm.js. Встроены: мониторинг ресурсов системы, удалённый файловый менеджер, AI-чат и интеграция с MCP.
